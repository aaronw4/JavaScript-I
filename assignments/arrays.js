...
// Help the dealer find out which car has an id of 33 by 
...
console.log(inventory[lastCar-1].car_make + ", " + inventory[lastCar-1].car_model);

// ==== Challenge 3 ====
// The marketing team wants the car models listed alphabetically on the website. 
//Sort all the car model names into alphabetical order and log the results in the 
//console
...
let myJsonBMWandAudi = JSON.stringify(BMWAndAudi);
console.log(myJsonBMWandAudi);
